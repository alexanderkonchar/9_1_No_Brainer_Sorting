//
// Created by Alex on 3/22/23.
//

#ifndef INC_9_1_NO_BRAINER_SORTING_COLLECTION_H
#define INC_9_1_NO_BRAINER_SORTING_COLLECTION_H
...
public:
    ...
    Collection<Item> &operator=(Collection<Item> &a);
...
ALGORITHM: if the start has exceeded the ending position
                return (base case)
...
#endif //INC_9_1_NO_BRAINER_SORTING_COLLECTION_H
